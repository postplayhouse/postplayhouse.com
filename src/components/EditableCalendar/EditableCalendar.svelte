	...
	{#each dates as day, i}
		...
		>
			<div class="relative flex justify-end">
				{#if day.day === 1 || i === 0}
					<div
						class="origin-left scale-125 -rotate-12 font-bold [text-shadow:0.035em_0.035em_0px_rgba(0,0,0,.5),0.035em_0.07em_0px_rgba(0,0,0,.5),0_0_4px_rgba(0,0,0,.5)] md:-translate-x-2
						md:scale-[2]"
					>
