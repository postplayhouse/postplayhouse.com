...
{#if year_ === 2023 || year_ === 2024}
	<ul
		class="m-auto grid max-w-120 list-none grid-flow-dense grid-cols-2 items-center gap-8 rounded-sm p-4 lg:max-w-full lg:grid-cols-4 dark:bg-white/80"
	>
		<li>
...
{:else if year_ === 2025 || year_ === 2026 || year_ === 2027}
	<ul
